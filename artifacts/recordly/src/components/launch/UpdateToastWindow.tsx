...
export function UpdateToastWindow() {
	...
	const cardStyle = {
		...
		border: "1px solid rgba(160, 103, 58, 0.24)",
	...
	const iconBoxStyle = {
		...
		alignItems: "center",
		justifyContent: "center",
		background: "rgba(160, 103, 58, 0.16)",
		color: "#c8906a",
		boxShadow: "inset 0 0 0 1px rgba(160, 103, 58, 0.18)",
	} as const;
	const titleStyle = {
		fontSize: 15,
		fontWeight: 700,
	...
	const primaryButtonStyle = {
		...subtleButtonStyle,
		border: "none",
		background: "linear-gradient(180deg, #3b82f6 0%, #a0673a 100%)",
		color: "#ffffff",
		boxShadow: "0 12px 24px rgba(160, 103, 58, 0.26)",
	} as const;
	const selectStyle = {
		height: 38,
		borderRadius: 12,
		padding: "0 34px 0 12px",
		border: "1px solid rgba(160, 103, 58, 0.22)",
		background:
		...
		fontWeight: 600,
		outline: "none",
		boxShadow: "inset 0 0 0 1px rgba(160, 103, 58, 0.06)",
		cursor: "pointer",
	} as const;
						...
						{payload.isPreview ? (
							<span
								style={{
									...
									border: "1px solid rgba(160, 103, 58, 0.18)",
								}}
							>
								Dev
							</span>
							...
							>
								<div
									style={{
										...
										borderRadius: 999,
										background:
											"linear-gradient(90deg, #c8906a 0%, #a0673a 45%, #8a5530 100%)",
										boxShadow: "0 0 22px rgba(160, 103, 58, 0.38)",
									}}
								/>
							</div>
							<div
								...
								{phaseStats.map((stat) => (
									<span
										...
										style={{
											...
											borderRadius: 999,
											padding: "4px 8px",
											border: "1px solid rgba(160, 103, 58, 0.16)",
										}}
									>
