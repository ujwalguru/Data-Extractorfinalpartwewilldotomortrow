...
export default function VideoEditor() {
        ...
        const handleZoom3dChange = useCallback(
                (effect3d: ZoomRegion3DEffect) => {
                        if (!selectedZoomId) return;
                        setZoomRegions((prev) =>
                                prev.map((region) => (region.id === selectedZoomId ? { ...region, effect3d } : region)),
                        );
                },
                [selectedZoomId],
        );
        ...
        return (
                <div className="flex flex-col h-screen bg-editor-bg text-foreground overflow-hidden selection:bg-[#a0673a]/30">
                        <div
                        ...
                        >
                                ...
                                >
                                        {isEditingProjectName ? (
                                                ...
                                                >
                                                        {hasUnsavedChanges ? (
                                                                <span className="mt-[1px] size-2 shrink-0 rounded-full bg-[#a0673a]" />
                                                        ) : null}
                                                        <input
                                                                ...
                                                                >
                                                                        ...
                                                                        <div className="flex items-center gap-2">
                                                                                ...
                                                                                <Button
                                                                                        type="submit"
                                                                                        size="sm"
                                                                                        className="h-9 rounded-xl bg-[#a0673a] px-3 text-white hover:bg-[#8a5530]"
                                                                                >
                                                                                                ...
                                                                                                return (
                                                                                                        <div
                                                                                                                ...
                                                                                                                className={cn(
                                                                                                                        ...
                                                                                                                        isActive
                                                                                                                                ? "border-[#a0673a]/20 bg-[#a0673a]/10 text-foreground"
                                                                                                        ...
                                                                                                        >
                                                                                                                ...
                                                                                                                >
                                                                                                                        ...
                                                                                                                        {isActive ? (
                                                                                                                                <Check className="h-3.5 w-3.5 shrink-0 text-[#a0673a]" />
                                                                                                                        ) : null}
                                                                                                                </button>
                                                                                                                <button
                                                                                                                        type="button"
                                        ...
                                        >
                                                <DropdownMenuTrigger asChild>
                                                        <Button
                                                                ...
                                                                className="inline-flex h-8 min-w-[112px] items-center justify-center gap-2 rounded-[5px] bg-[#a0673a] px-4.5 text-white transition-colors hover:bg-[#a0673a]/92"
                                                        >
                                                                ...
                                                                <div className="rounded-2xl border border-foreground/10 bg-editor-surface p-4 text-foreground shadow-2xl">
                                                                        ...
                                                                        <div className="h-2 overflow-hidden rounded-full border border-foreground/5 bg-foreground/5">
                                                                                ...
                                                                                isExportFinalSaveIndeterminate ? (
                                                                                        ...
                                                                                        <div
                                                                                                className="h-full bg-[#a0673a] transition-all duration-300 ease-out"
                                                                                                style={{
                                                                        ...
                                                                        <div className="mt-4 flex gap-2">
                                                                                {hasPendingExportSave ? (
                                                                                        <Button
                                                                                                ...
                                                                                                className="h-8 flex-1 rounded-[5px] bg-[#a0673a] text-xs font-semibold text-white hover:bg-[#a0673a]/92"
                                                                                        >
                                        ...
                                        <div className="flex flex-shrink-0 gap-1.5">
                                                                                ...
                                                                                <div className="ml-1.5 h-1.5 w-1.5 flex-shrink-0">
                                                                                        {isActive && (
                                                                                                <motion.span
                                                                                                        ...
                                                                                                        className="block h-1.5 w-1.5 rounded-full bg-[#a0673a]"
                                                ...
                                                {activeEffectSection === "extensions" ? (
                                                        ...
                                                        <SettingsPanel
                                                                ...
                                                                selectedZoom3d={
                                                                        selectedZoomId
                                                                                ? (zoomRegions.find((z) => z.id === selectedZoomId)?.effect3d ?? null)
                                                                                : null
                                                                }
                                                                onZoom3dChange={(effect3d) =>
                                                                        selectedZoomId && handleZoom3dChange(effect3d)
                                                                }
                                                        ...
                                                        <div className="relative flex flex-1 min-h-0 flex-col overflow-hidden">
                                                                ...
                                                                <div className="flex items-center justify-center gap-2 py-1.5 flex-shrink-0">
                                                                                ...
                                                                                >
                                                                                        {ASPECT_RATIOS.map((ratio) => (
                                                                                                ...
                                                                                                >
                                                                                                        ...
                                                                                                        {aspectRatio === ratio && (
                                                                                                                <Check className="w-3 h-3 text-[#a0673a]" />
                                                                                                        )}
                                                                                                </DropdownMenuItem>
                                                                                        ))}
                                                                                </DropdownMenuContent>
                                                                        ...
                                                                        >
                                                                                ...
                                                                                {isCropped ? (
                                                                                        <span className="h-1.5 w-1.5 rounded-full bg-[#a0673a]" />
                                                                                ) : null}
                                                                        </Button>
                                                                </div>
                                                                {/* Video preview */}
                                                ...
                                                <div className="relative flex flex-shrink-0 items-center px-1 py-1">
                                                        ...
                                                        <div className="z-10 flex min-w-0 flex-1 items-center gap-1.5">
                                                                ...
                                                                <Button
                                                                        ...
                                                                        variant="ghost"
                                                                        size="icon"
                                                                        className="h-7 w-7 rounded-full text-muted-foreground transition-all hover:bg-[#a0673a]/10 hover:text-[#a0673a]"
                                                        ...
                                                        <div className="z-10 ml-auto flex items-center gap-2">
                                                                ...
                                                                <div className="flex items-center gap-1.5">
                                                                        ...
                                                                        <div className="relative flex h-7 w-24 select-none items-center overflow-hidden rounded-full border border-foreground/[0.06] bg-editor-bg/80 shadow-[inset_0_1px_0_hsl(var(--foreground)/0.06)]">
                                                                                ...
                                                                                />
                                                                                <div
                                                                                        className="pointer-events-none absolute bottom-[18%] top-[18%] z-10 w-[2px] rounded-full bg-foreground/95 shadow-[0_0_10px_rgba(160,103,58,0.28)]"
                                        ...
                                        <div className="fixed left-1/2 top-1/2 z-[60] max-h-[90vh] w-[90vw] max-w-5xl -translate-x-1/2 -translate-y-1/2 overflow-auto rounded-2xl border border-foreground/10 bg-editor-dialog p-8 shadow-2xl animate-in zoom-in-95 duration-200">
                                                ...
                                                <div className="mt-6 flex justify-end">
                                                        <Button
                                                                ...
                                                                size="lg"
                                                                className="bg-[#a0673a] text-white hover:bg-[#a0673a]/90"
                                                        >
