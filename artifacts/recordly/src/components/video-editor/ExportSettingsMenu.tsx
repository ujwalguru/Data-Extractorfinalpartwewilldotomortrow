	...
	return (
		...
		>
						...
						return (
							<button
								...
								className={cn(
									...
									isActive
										? "border-[#a0673a]/50 text-[#a0673a] dark:text-white"
							...
							>
								{isActive ? (
									<motion.span
										...
										className="absolute inset-0 rounded-xl bg-[#a0673a]/10"
					...
					<div className="flex items-center justify-between px-1">
						...
						<div className="flex items-center gap-2">
							...
							<Switch
								...
								className="scale-75 data-[state=checked]:bg-[#a0673a]"
							/>
						</div>
					</div>
				</div>
			...
			<Button
				...
				size="lg"
				onClick={onExport}
				className="h-11 w-full gap-2 rounded-lg bg-[#a0673a] text-sm font-semibold text-white transition-colors duration-200 hover:bg-[#a0673a]/90"
			>
