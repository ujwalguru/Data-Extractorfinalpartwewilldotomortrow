                                        ...
                                        return (
                                                <button
                                                        ...
                                                        className={cn(
                                                                ...
                                                                isActive &&
                                                                        "border-[#a0673a]/70 bg-[#a0673a]/12 shadow-[inset_0_0_0_1px_rgba(160,103,58,0.15)]",
                                                        )}
                                                >
                                                        <div className="flex items-start gap-3">
                                                                <div
                                                                        className={cn(
                                                                                ...
                                                                                isActive &&
                                                                                        "border-[#a0673a]/30 bg-[#a0673a]/10 text-[#75A6FF]",
                                                                        )}
                                                                >
...
interface SettingsPanelProps {
        ...
        selectedZoom3d?: ZoomRegion3DEffect | null;
        onZoom3dChange?: (effect3d: ZoomRegion3DEffect) => void;
...
const WEBCAM_SHAPES: Array<{
        ...
        },
        {
                ...
                icon: (
                        <svg width="16" height="12" viewBox="0 0 16 12" fill="none">
                                <rect x="2" y="1" width="12" height="10" rx="3.5" stroke="currentColor" strokeWidth="1.2"/>
                        </svg>
                ),
        },
        {
                ...
                icon: (
                        <svg width="16" height="12" viewBox="0 0 16 12" fill="none">
                                <rect x="1" y="2" width="14" height="8" rx="4" stroke="currentColor" strokeWidth="1.2"/>
                        </svg>
                ),
        },
        {
        ...
        },
        {
                ...
                icon: (
                        <svg width="16" height="12" viewBox="0 0 16 12" fill="none">
                                <rect x="1" y="1" width="14" height="10" rx="0" stroke="currentColor" strokeWidth="1.2"/>
                        </svg>
                ),
        },
];
...
export function SettingsPanel({
        ...
        const wallpaperTileClass = (isSelected: boolean) =>
                cn(
                        ...
                        isSelected
                                ? "border-[#a0673a] bg-foreground/[0.08]"
        ...
        const applyWebcamLayout = (preset: LayoutPreset, size: number, cornerRadius: number, webcamAspectRatio: number, margin: number) => {
                if (!webcam || !onWebcamChange) return;
                const position = getWebcamPositionForPreset(preset);
                onWebcamChange({
                        ...webcam,
                                                                ...
                                                                >
                                                                        {isActive ? (
                                                                                <motion.span
                                                                                        ...
                                                                                        className="absolute inset-0 rounded-lg bg-[#a0673a]"
                                                                                        transition={{
                                                                                                type: "spring",
                                                                                                stiffness: 420,
                                                                                                damping: 34,
                                                        ...
                                                        {backgroundTab === "image" ? (
                                                                <div className="mt-0 space-y-2">
                                                                        ...
                                                                        <Button
                                                                                ...
                                                                                variant="outline"
                                                                                className="w-full gap-2 bg-foreground/5 text-foreground border-foreground/10 hover:bg-[#a0673a] hover:text-white hover:border-[#a0673a] transition-all h-7 text-[10px]"
                                                                        >
                        ...
                        <div className="flex-[2] w-[332px] min-w-[280px] max-w-[332px] bg-editor-panel rounded-2xl flex flex-col shadow-xl h-full overflow-hidden">
                                ...
                                >
                                        <div className="mb-4 flex items-center gap-2">
                                                <Palette className="w-4 h-4 text-[#a0673a]" />
                                                ...
                                                <div className="flex items-center justify-between">
                                                        ...
                                                        {frame && (
                                                                <button
                                                                        ...
                                                                        className="text-[9px] text-[#a0673a] hover:opacity-80"
                                                                >
                                                                        Remove
                                                                </button>
                                                        )}
                                                                ...
                                                                return (
                                                                        <button
                                                                                ...
                                                                                className={cn(
                                                                                        ...
                                                                                        isSelected
                                                                                                ? "border-[#a0673a]/50 bg-[#a0673a]/10 ring-1 ring-[#a0673a]/30"
                        ...
                        <div className="rounded-lg bg-foreground/[0.03] px-2.5 py-2 space-y-3">
                                        ...
                                        <div className="grid w-full grid-cols-2 gap-2">
                                                {whisperModelDownloadStatus === "downloading" ? (
                                                        ...
                                                        <Button
                                                                ...
                                                                className="h-10 w-full rounded-xl bg-[#a0673a] px-4 text-sm font-medium text-white hover:bg-[#a0673a]/90"
                                                        >
                                ...
                                <div className="flex flex-col gap-2">
                                        <Button
                                                ...
                                                className="h-10 w-full rounded-xl bg-[#a0673a] px-4 text-sm font-medium text-white hover:bg-[#a0673a]/90 disabled:opacity-60"
                                        >
                ...
                const settingsSectionContent = (
                        <div className="space-y-4">
                                ...
                                {showDevMotionControls ? (
                                        <section className="flex flex-col gap-2 rounded-xl border border-[#a0673a]/15 bg-[#a0673a]/5 p-3">
                                                <div className="flex items-center justify-between gap-3">
                                                        <div>
                                                                <SectionLabel>
                                                        ...
                                                        <span className="rounded-full bg-[#a0673a]/10 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wider text-[#a0673a]">
                                                                DEV
                                                        </span>
                                                </div>
                                                ...
                                                <div className="rounded-lg border border-foreground/10 bg-background/60 px-3 py-3">
                                                        <div className="flex items-start justify-between gap-3">
                                                                ...
                                                                <Button
                                                                        ...
                                                                        className="h-8 shrink-0 border-[#a0673a]/20 bg-[#a0673a]/10 text-[#a0673a] hover:bg-[#a0673a]/15"
                                                                >
                                                                ...
                                                                <button
                                                                        ...
                                                                        className={cn(
                                                                                ...
                                                                                selectedZoomMode === "auto"
                                                                                        ? "bg-[#a0673a] text-white shadow-sm"
                                                                                        : "text-muted-foreground hover:text-foreground",
                                                                        )}
                                                                >
                                                                ...
                                                                return (
                                                                        <Button
                                                                                ...
                                                                                className={cn(
                                                                                        ...
                                                                                        isActive
                                                                                                ? "border-[#a0673a] bg-[#a0673a] text-white"
                                                ...
                                                <div className="rounded-xl border border-foreground/[0.08] bg-foreground/[0.03] overflow-hidden">
                                                        ...
                                                        <div className="flex items-center justify-between px-3 py-2.5 border-b border-foreground/[0.06]">
                                                                <div className="flex items-center gap-2">
                                                                        <div className="flex h-5 w-5 items-center justify-center rounded-md bg-gradient-to-br from-indigo-500/25 to-purple-600/25 border border-indigo-400/20">
                                                                                <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                                                                                        <path d="M5 1L9 3.5V6.5L5 9L1 6.5V3.5L5 1Z" stroke="currentColor" strokeWidth="0.8" className="text-indigo-300" fill="none"/>
                                                                                        <path d="M5 1V9M1 3.5L9 3.5" stroke="currentColor" strokeWidth="0.5" className="text-indigo-300/50"/>
                                                                                </svg>
                                                                        </div>
                                                                        <div>
                                                                                <div className="text-[10px] font-semibold text-foreground/90">3D Effect</div>
                                                                                <div className="text-[9px] text-muted-foreground/55">Perspective tilt with depth</div>
                                                                        </div>
                                                                </div>
                                                                <Switch
                                                                        checked={selectedZoom3d?.enabled ?? false}
                                                                        onCheckedChange={(enabled) =>
                                                                                onZoom3dChange?.({ ...DEFAULT_ZOOM_3D_EFFECT, ...selectedZoom3d, enabled })
                                                                        }
                                                                        className="data-[state=checked]:bg-[#a0673a] scale-75"
                                                                />
                                                        </div>
                                                        ...
                                                        {selectedZoom3d?.enabled && (() => {
                                                                const tx = selectedZoom3d?.tiltX ?? DEFAULT_ZOOM_3D_EFFECT.tiltX;
                                                                const ty = selectedZoom3d?.tiltY ?? DEFAULT_ZOOM_3D_EFFECT.tiltY;
                                                                const intens = selectedZoom3d?.intensity ?? DEFAULT_ZOOM_3D_EFFECT.intensity;
                                                                const previewRotY = tx * intens * 28;
                                                                const previewRotX = -ty * intens * 28;
                                                                const shadowX = -tx * intens * 10;
                                                                const shadowY = ty * intens * 10;
                                                                return (
                                                                        <div className="px-3 pt-3 pb-3 flex flex-col gap-3">
                                                                                        ...
                                                                                        <div style={{ perspective: "220px" }}>
                                                                                                <div
                                                                                                        style={{
                                                                                                                ...
                                                                                                                height: 60,
                                                                                                                borderRadius: 7,
                                                                                                                background: "linear-gradient(135deg, #1e1b2e 0%, #14122a 100%)",
                                                                                                                border: "1px solid rgba(160,103,58,0.35)",
                                                                                                                transform: `rotateY(${previewRotY}deg) rotateX(${previewRotX}deg)`,
                                                                                                                transition: "transform 0.25s cubic-bezier(0.16,1,0.3,1), box-shadow 0.25s ease",
                                                                                                                boxShadow: `${shadowX}px ${shadowY}px 22px rgba(0,0,0,0.65), inset 0 1px 0 rgba(255,255,255,0.06)`,
                                                                                                                overflow: "hidden",
                                                                                                                position: "relative",
                                                                                                        }}
                                                                                                >
                                                                                                        {/* Fake screen lines */}
                                                                                                        <div style={{ position: "absolute", inset: 6, borderRadius: 3, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)" }}>
                                                                                                                <div style={{ margin: "6px 7px 4px", height: 3, borderRadius: 2, background: "rgba(160,103,58,0.4)" }} />
                                                                                                                <div style={{ margin: "0 7px 3px", height: 2, borderRadius: 2, background: "rgba(255,255,255,0.12)" }} />
                                                                                                                <div style={{ margin: "0 7px", height: 2, borderRadius: 2, background: "rgba(255,255,255,0.08)", width: "60%" }} />
                                                                                                        </div>
                                                                                                        {/* Glint highlight that moves with tilt */}
                                                                                                        <div style={{
                                                                                                                position: "absolute",
                                                                                                                inset: 0,
                                                                                                                background: `radial-gradient(ellipse at ${50 - tx * intens * 35}% ${50 - ty * intens * 35}%, rgba(255,255,255,0.07) 0%, transparent 65%)`,
                                                                                                                pointerEvents: "none",
                                                                                                        }} />
                                                                                                </div>
                                                                                        </div>
                                                                                ...
                                                                                <SliderControl
                                                                                        label="Intensity"
                                                                                        value={intens * 100}
                                                                                        defaultValue={DEFAULT_ZOOM_3D_EFFECT.intensity * 100}
                                                                                        min={0}
                                                                                        max={100}
                                                                                        step={1}
                                                                                        onChange={(v) =>
                                                                                                onZoom3dChange?.({ ...DEFAULT_ZOOM_3D_EFFECT, ...selectedZoom3d, intensity: v / 100 })
                                                                                        }
                                                                                        formatValue={(v) => `${Math.round(v)}%`}
                                                                                        parseInput={(text) => parseFloat(text.replace(/%$/, ""))}
                                                                                />

                                                                                {/* Draggable tilt direction picker */}
                                                                                <div>
                                                                                        <div className="flex items-center justify-between mb-1.5">
                                                                                                <span className="text-[9px] text-muted-foreground/60 uppercase tracking-wide">Perspective direction</span>
                                                                                                <button
                                                                                                        type="button"
                                                                                                        className="text-[9px] text-muted-foreground/40 hover:text-muted-foreground/70 transition-colors"
                                                                                                        onClick={() => onZoom3dChange?.({ ...DEFAULT_ZOOM_3D_EFFECT, ...selectedZoom3d, tiltX: DEFAULT_ZOOM_3D_EFFECT.tiltX, tiltY: DEFAULT_ZOOM_3D_EFFECT.tiltY })}
                                                                                                >
                                                                                                        Reset
                                                                                                </button>
                                                                                        </div>
                                                                                        <div
                                                                                                className="relative mx-auto w-full rounded-xl overflow-hidden cursor-crosshair select-none"
                                                                                                style={{
                                                                                                        height: 100,
                                                                                                        background: "radial-gradient(ellipse at center, rgba(160,103,58,0.08) 0%, rgba(0,0,0,0) 70%), linear-gradient(135deg, rgba(255,255,255,0.02), rgba(255,255,255,0.01))",
                                                                                                ...
                                                                                                onPointerDown={(e) => {
                                                                                                        ...
                                                                                                        onZoom3dChange?.({ ...DEFAULT_ZOOM_3D_EFFECT, ...selectedZoom3d, tiltX: Math.round(x * 10) / 10, tiltY: Math.round(y * 10) / 10 });
                                                                                                }}
                                                                                                onPointerMove={(e) => {
                                                                                        ...
                                                                                        >
                                                                                                ...
                                                                                                {/* Corner labels */}
                                                                                                <span className="absolute top-1.5 left-2 text-[7px] text-foreground/20 pointer-events-none font-mono">TL</span>
                                                                                                <span className="absolute top-1.5 right-2 text-[7px] text-foreground/20 pointer-events-none font-mono">TR</span>
                                                                                                <span className="absolute bottom-1.5 left-2 text-[7px] text-foreground/20 pointer-events-none font-mono">BL</span>
                                                                                                <span className="absolute bottom-1.5 right-2 text-[7px] text-foreground/20 pointer-events-none font-mono">BR</span>
                                                                                                {/* Active tilt dot with glow */}
                                                                                                <div
                                                                                                ...
                                                                                                >
                                                                                                        ...
                                                                                                        <div style={{
                                                                                                                ...
                                                                                                                inset: -6,
                                                                                                                borderRadius: "50%",
                                                                                                                background: "rgba(160,103,58,0.18)",
                                                                                                                filter: "blur(4px)",
                                                                                                        }} />
                                                                                                        {/* Main dot */}
                                                                                                        <div style={{
                                                                                                                ...
                                                                                                                height: 14,
                                                                                                                borderRadius: "50%",
                                                                                                                background: "radial-gradient(circle at 35% 35%, #d4884a, #a0673a)",
                                                                                                                border: "2px solid rgba(255,255,255,0.75)",
                                                                                                                boxShadow: "0 2px 8px rgba(0,0,0,0.6), 0 0 0 1px rgba(160,103,58,0.4)",
                                                                                                                position: "relative",
                                                                                                        }} />
                                                                                                </div>
                                                                                                {/* Direction arrow hint */}
                                                                                                <div className="absolute bottom-1.5 left-1/2 -translate-x-1/2 text-[7.5px] text-foreground/20 pointer-events-none tracking-wide">
                                                                                                        drag to set
                                                                                                </div>
                                                                                        </div>
                                                                                </div>
                                                                        ...
                                                                        {cursorStyleOptions.map((option) => (
                                                                                <ToggleGroupItem
                                                                                        ...
                                                                                        className={cn(
                                                                                                ...
                                                                                                "data-[state=on]:border-[#a0673a]/70 data-[state=on]:bg-[#a0673a]/12 data-[state=on]:text-foreground",
                                                                                        )}
                                                                                >
