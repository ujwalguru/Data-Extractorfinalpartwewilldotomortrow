...
export interface ZoomRegion3DEffect {
        enabled: boolean;
        intensity: number; // 0–1
        tiltX: number; // -1 to 1 (horizontal, drives rotateY)
        tiltY: number; // -1 to 1 (vertical, drives rotateX)
}

export const DEFAULT_ZOOM_3D_EFFECT: ZoomRegion3DEffect = {
        enabled: false,
        intensity: 0.5,
        tiltX: 0.5,
        tiltY: 0.3,
