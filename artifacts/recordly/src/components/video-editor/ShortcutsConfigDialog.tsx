			...
			<DialogContent className="bg-editor-dialog border-foreground/10 text-foreground max-w-[460px]">
				<DialogHeader>
					<DialogTitle className="flex items-center gap-2 text-sm">
						<Keyboard className="w-4 h-4 text-[#a0673a]" />
								...
								<div className="flex items-center justify-between py-1.5 px-1 border-b border-foreground/5">
									...
									<button
										...
										className={[
											...
											isCapturing
												? "bg-[#a0673a]/20 border-[#a0673a] text-[#a0673a] animate-pulse"
												: hasConflict
													? "bg-amber-500/10 border-amber-500/50 text-amber-400"
													: "bg-foreground/5 border-foreground/10 text-foreground hover:border-[#a0673a]/50 hover:text-[#a0673a] cursor-pointer",
										].join(" ")}
									>
										{isCapturing
				...
				<DialogFooter className="flex gap-2 sm:justify-between mt-2">
					...
					<div className="flex gap-2">
						...
						<Button
							size="sm"
							className="bg-[#a0673a] hover:bg-[#8a5530] text-white"
							onClick={handleSave}
						>
