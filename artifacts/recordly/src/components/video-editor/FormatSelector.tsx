				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-[#a0673a]/50 focus:ring-offset-2 focus:ring-offset-editor-dialog",
							isSelected
								? "bg-[#a0673a]/10 border-[#a0673a]/50 text-[#a0673a] dark:text-white"
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-[#a0673a]/20 text-[#a0673a]" : "bg-foreground/5",
							)}
						>
							{option.icon}
						</div>
						...
						{isSelected && (
							<div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#a0673a]" />
						)}
					</button>
				);
			})}
